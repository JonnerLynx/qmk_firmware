 ...
 * '------------+--------+--------+--------+--------+-----------------'                 '-----------------+--------+--------+--------+--------+------------'
 *     |        |        |        |        |        |                                                     |        |        |        |        |        |
 *     |  CTRL  |   ALT  | CTRL+X | CTRL+C | CTRL+V |                                                     |    {   |    }   |    =   |   ALT  |  CTRL  |
 *     |        |        |        |        |        |                                                     |        |        |        |        |        |
 *     '--------------------------------------------'                                                     '--------'--------'--------'--------'--------'
 *
 *                                                  .-----------------.                 .-----------------.
...
[L0] = LAYOUT_ergodox(
    ...
    KC_LCTL,            KC_LALT,        RCTL(KC_X),     LCTL(KC_C),     LCTL(KC_V),     /**/            /**/
 ...
 * |------------+--------+--------+--------+--------+--------|        |                 |        |--------+--------+--------+--------+--------+------------|
 * |            |        |  CTRL  |        |        |        |        |                 |        |        |        |        |        |        |            |
 * |            |   ALT  |    +   |  CTRL  |  [~LT] |        +--------|                 |--------+        |  Left  |  Down  |  Right |   TAB  |            |
 * |            |        |  SHIFT |        |        |        |        |                 |        |        |        |        |        |        |            |
 * |------------+--------+--------+--------+--------+--------|        |                 |        |--------+--------+--------+--------+--------+------------|
 * |            |        |        |        |        |        |   L0   |                 |   L0   |        |        |        |        |        |            |
 * |            |        |        |        |        |        |        |                 |        |        |        |        |        |        |            |
...
[L1] = LAYOUT_ergodox(
    ...
    KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_LGUI,       KC_TRNS,        KC_TRNS,        TO(L2),
    KC_TRNS,        KC_LALT,        LCTL(KC_LSFT),  KC_LCTL,       KC_TRNS,        KC_TRNS,        /**/
